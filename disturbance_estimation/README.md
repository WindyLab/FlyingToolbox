...
### Hardware
If disturbance ground truth collection is not required, only the disturbance estimation function can be used. In this case, it is sufficient to publish the position and attitude information of the manipulator MAV and the toolbox MAV in the motion capture system to enable disturbance estimation.  
